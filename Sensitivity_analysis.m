...
hold on
wij=Net.iw{1,1};
PP1=sum(abs(wij(:,1)))/(sum(abs(wij(:,1)))+sum(abs(wij(:,2)))+sum(abs(wij(:,3)))+sum(abs(wij(:,4)))+sum(abs(wij(:,5)))...
+sum(abs(wij(:,6)))+sum(abs(wij(:,7)))+sum(abs(wij(:,8)))+sum(abs(wij(:,9)))+sum(abs(wij(:,10)))+sum(abs(wij(:,11)))+sum(abs(wij(:,12)))+sum(abs(wij(:,13))));%第一输入元素敏感系数
PP2=sum(abs(wij(:,2)))/(sum(abs(wij(:,1)))+sum(abs(wij(:,2)))+sum(abs(wij(:,3)))+sum(abs(wij(:,4)))+sum(abs(wij(:,5)))...
+sum(abs(wij(:,6)))+sum(abs(wij(:,7)))+sum(abs(wij(:,8)))+sum(abs(wij(:,9)))+sum(abs(wij(:,10)))+sum(abs(wij(:,11)))+sum(abs(wij(:,12)))+sum(abs(wij(:,13))));%第一输入元素敏感系数
PP3=sum(abs(wij(:,3)))/(sum(abs(wij(:,1)))+sum(abs(wij(:,2)))+sum(abs(wij(:,3)))+sum(abs(wij(:,4)))+sum(abs(wij(:,5)))...
+sum(abs(wij(:,6)))+sum(abs(wij(:,7)))+sum(abs(wij(:,8)))+sum(abs(wij(:,9)))+sum(abs(wij(:,10)))+sum(abs(wij(:,11)))+sum(abs(wij(:,12)))+sum(abs(wij(:,13))));%第一输入元素敏感系数
PP4=sum(abs(wij(:,4)))/(sum(abs(wij(:,1)))+sum(abs(wij(:,2)))+sum(abs(wij(:,3)))+sum(abs(wij(:,4)))+sum(abs(wij(:,5)))...
+sum(abs(wij(:,6)))+sum(abs(wij(:,7)))+sum(abs(wij(:,8)))+sum(abs(wij(:,9)))+sum(abs(wij(:,10)))+sum(abs(wij(:,11)))+sum(abs(wij(:,12)))+sum(abs(wij(:,13))));%第一输入元素敏感系数
PP5=sum(abs(wij(:,5)))/(sum(abs(wij(:,1)))+sum(abs(wij(:,2)))+sum(abs(wij(:,3)))+sum(abs(wij(:,4)))+sum(abs(wij(:,5)))...
+sum(abs(wij(:,6)))+sum(abs(wij(:,7)))+sum(abs(wij(:,8)))+sum(abs(wij(:,9)))+sum(abs(wij(:,10)))+sum(abs(wij(:,11)))+sum(abs(wij(:,12)))+sum(abs(wij(:,13))));%第一输入元素敏感系数
PP6=sum(abs(wij(:,6)))/(sum(abs(wij(:,1)))+sum(abs(wij(:,2)))+sum(abs(wij(:,3)))+sum(abs(wij(:,4)))+sum(abs(wij(:,5)))...
+sum(abs(wij(:,6)))+sum(abs(wij(:,7)))+sum(abs(wij(:,8)))+sum(abs(wij(:,9)))+sum(abs(wij(:,10)))+sum(abs(wij(:,11)))+sum(abs(wij(:,12)))+sum(abs(wij(:,13))));%第一输入元素敏感系数
PP7=sum(abs(wij(:,7)))/(sum(abs(wij(:,1)))+sum(abs(wij(:,2)))+sum(abs(wij(:,3)))+sum(abs(wij(:,4)))+sum(abs(wij(:,5)))...
+sum(abs(wij(:,6)))+sum(abs(wij(:,7)))+sum(abs(wij(:,8)))+sum(abs(wij(:,9)))+sum(abs(wij(:,10)))+sum(abs(wij(:,11)))+sum(abs(wij(:,12)))+sum(abs(wij(:,13))));%第一输入元素敏感系数
PP8=sum(abs(wij(:,8)))/(sum(abs(wij(:,1)))+sum(abs(wij(:,2)))+sum(abs(wij(:,3)))+sum(abs(wij(:,4)))+sum(abs(wij(:,5)))...
+sum(abs(wij(:,6)))+sum(abs(wij(:,7)))+sum(abs(wij(:,8)))+sum(abs(wij(:,9)))+sum(abs(wij(:,10)))+sum(abs(wij(:,11)))+sum(abs(wij(:,12)))+sum(abs(wij(:,13))));%第一输入元素敏感系数
PP9=sum(abs(wij(:,9)))/(sum(abs(wij(:,1)))+sum(abs(wij(:,2)))+sum(abs(wij(:,3)))+sum(abs(wij(:,4)))+sum(abs(wij(:,5)))...
+sum(abs(wij(:,6)))+sum(abs(wij(:,7)))+sum(abs(wij(:,8)))+sum(abs(wij(:,9)))+sum(abs(wij(:,10)))+sum(abs(wij(:,11)))+sum(abs(wij(:,12)))+sum(abs(wij(:,13))));%第一输入元素敏感系数
PP10=sum(abs(wij(:,10)))/(sum(abs(wij(:,1)))+sum(abs(wij(:,2)))+sum(abs(wij(:,3)))+sum(abs(wij(:,4)))+sum(abs(wij(:,5)))...
+sum(abs(wij(:,6)))+sum(abs(wij(:,7)))+sum(abs(wij(:,8)))+sum(abs(wij(:,9)))+sum(abs(wij(:,10)))+sum(abs(wij(:,11)))+sum(abs(wij(:,12)))+sum(abs(wij(:,13))));%第一输入元素敏感系数
PP11=sum(abs(wij(:,11)))/(sum(abs(wij(:,1)))+sum(abs(wij(:,2)))+sum(abs(wij(:,3)))+sum(abs(wij(:,4)))+sum(abs(wij(:,5)))...
+sum(abs(wij(:,6)))+sum(abs(wij(:,7)))+sum(abs(wij(:,8)))+sum(abs(wij(:,9)))+sum(abs(wij(:,10)))+sum(abs(wij(:,11)))+sum(abs(wij(:,12)))+sum(abs(wij(:,13))));%第一输入元素敏感系数
PP12=sum(abs(wij(:,12)))/(sum(abs(wij(:,1)))+sum(abs(wij(:,2)))+sum(abs(wij(:,3)))+sum(abs(wij(:,4)))+sum(abs(wij(:,5)))...
+sum(abs(wij(:,6)))+sum(abs(wij(:,7)))+sum(abs(wij(:,8)))+sum(abs(wij(:,9)))+sum(abs(wij(:,10)))+sum(abs(wij(:,11)))+sum(abs(wij(:,12)))+sum(abs(wij(:,13))));%第一输入元素敏感系数
PP13=sum(abs(wij(:,13)))/(sum(abs(wij(:,1)))+sum(abs(wij(:,2)))+sum(abs(wij(:,3)))+sum(abs(wij(:,4)))+sum(abs(wij(:,5)))...
+sum(abs(wij(:,6)))+sum(abs(wij(:,7)))+sum(abs(wij(:,8)))+sum(abs(wij(:,9)))+sum(abs(wij(:,10)))+sum(abs(wij(:,11)))+sum(abs(wij(:,12)))+sum(abs(wij(:,13))));%第一输入元素敏感系数
PP=[PP1;PP2;PP3;PP4;PP5;PP6;PP7;PP8;PP9;PP10;PP11;PP12;PP13];
PP_SUM=0;
for i=1:13
    PP_SUM=PP_SUM+PP(i,1);
end
